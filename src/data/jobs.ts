...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Created frictionless and highly automated deployment playbooks ensuring minimal disruption to business operations',
      'Engineered monitoring solutions to ensure availability, integrity, and confidentiality of platforms',
      'Served as subject-matter-expert for Azure/M365, analyzing needs and designing solutions',
      ...
      'Aligned technology solutions with business objectives while ensuring security compliance',
      'Created C# function app automating certificate version synchronization between key vaults',
      'Managed seamless connectivity and identity management between enterprise business systems',
      'Reorganized and enhanced technical documentation to improve knowledge sharing and onboarding',
      'Utilized Jenkins and Ansible to automate deployment pipelines, QA Tests, and daily TLS validation'
    ],
    technologies: [
